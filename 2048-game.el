...
(defface 2048-face-2    '((t . (:background "khaki"))) "Face for the tile 2")
(defface 2048-face-4    '((t . (:background "burlywood")))      "Face for the tile 4")
(defface 2048-face-8    '((t . (:background "orange3"))) "Face for the tile 8")
(defface 2048-face-16   '((t . (:background "orange")))        "Face for the tile 16")
(defface 2048-face-32   '((t . (:background "orange red")))        "Face for the tile 32")
(defface 2048-face-64   '((t . (:background "firebrick" :foreground "white")))   "Face for the tile 64")
(defface 2048-face-128  '((t . (:background "dark red" :foreground "white")))      "Face for the tile 128")
(defface 2048-face-256  '((t . (:background "dark magenta" :foreground "white")))         "Face for the tile 256")
(defface 2048-face-512  '((t . (:background "magenta")))         "Face for the tile 512")
(defface 2048-face-1024 '((t . (:background "gold")))         "Face for the tile 1024")
(defface 2048-face-2048 '((t . (:background "yellow")))         "Face for the tile 2048")
