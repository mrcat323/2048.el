...
(defface 2048-face-2    '((t . (:background "khaki" :foreground "white"))) "Face for the tile 2" :group '2048-faces)
(defface 2048-face-4    '((t . (:background "burlywood" :foreground "white"))) "Face for the tile 4" :group '2048-faces)
(defface 2048-face-8    '((t . (:background "orange3" :foreground "white"))) "Face for the tile 8" :group '2048-faces)
(defface 2048-face-16   '((t . (:background "orange" :foreground "white"))) "Face for the tile 16" :group '2048-faces)
(defface 2048-face-32   '((t . (:background "orange red" :foreground "white"))) "Face for the tile 32" :group '2048-faces)
...
(defface 2048-face-512  '((t . (:background "magenta" :foreground "white"))) "Face for the tile 512" :group '2048-faces)
(defface 2048-face-1024 '((t . (:background "gold" :foreground "white"))) "Face for the tile 1024" :group '2048-faces)
(defface 2048-face-2048 '((t . (:background "yellow" :foreground "white"))) "Face for the tile 2048" :group '2048-faces)
